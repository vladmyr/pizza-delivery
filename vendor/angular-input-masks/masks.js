...
.directive('uiPhoneNumber', ['PhoneValidators', function(PhoneValidators) {

	var phoneMask12D = new StringMask('+00 (000) 000-00-00');
	...
	function applyPhoneMask (value) {
		...
		var formatedValue = phoneMask12D.apply(value);
